...
//        // Act
//        User result = userDAO.findByEmail("testuser");
//
//        // Assert
...
//        // Act
//        User result = userDAO.findByEmailAndPassword()"testuser", "password123");
//
//        // Assert
//        assertNotNull(result);
//        assertEquals("testuser", result.getUsername());
...
//        // Act
//        User result = userDAO.findByEmailAndPassword("testuser", "wrongpassword");
//
//        // Assert
//        assertNull(result);
//    }
...
//        // Arrange
//        User user = userDAO.findByEmailAndPassword("testuser");
...
//        assertTrue(result);
//
//        User updatedUser = userDAO.findByEmail("testuser");
//        assertFalse(updatedUser.isActive());
//
//        // Verificar que um usuário inativo não pode fazer login
//        User authAttempt = userDAO.findByEmail("testuser", "password123");
